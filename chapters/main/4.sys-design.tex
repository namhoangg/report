...
% Below are some screens of the web application developed for the first phase, which do not encompass all functionalities. These selected interfaces illustrate key features and user interactions within the system.
% \begin{figure}[h]
%     \centering
...
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/admin_dashboard.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/rate-freight.png}
%     \caption{Freight Rate Management}
%     \label{fig:Freight Rate Management}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/rate-new-freight.png}
%     \caption{New Freight Rate}
%     \label{fig:New Freight Rate}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/new-sea-fcl-rates.png}
%     \caption{New SEA FCL Freight Rate}
%     \label{fig:New SEA FCL Freight Rate}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/local-charges.png}
%     \caption{Local Charges Management}
%     \label{fig:Local Charges Management}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/new-local-charges.png}
%     \caption{New Local Charge}
%     \label{fig:New Local Charge}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/providers.png}
%     \caption{Providers Management}
%     \label{fig:Providers Management}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/new-provider-1.png}
%     \caption{New Provider Screen 1}
%     \label{fig:New Provider Screen 1}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/new-provider-2.png}
%     \caption{New Provider Screen 2}
%     \label{fig:New Provider Screen 2}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/acl-peprmission.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=15cm]{graphics/UI/acl-role.png}
